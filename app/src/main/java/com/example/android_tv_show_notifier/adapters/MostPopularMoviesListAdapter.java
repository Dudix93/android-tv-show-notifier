...
public class MostPopularMoviesListAdapter extends RecyclerView.Adapter<MostPopularMoviesListAdapter.MovieViewHolder> {

    private ArrayList<MostPopularDataDetailModel> mMovies = new ArrayList<MostPopularDataDetailModel>();
    private Context mContext;

    public MostPopularMoviesListAdapter(ArrayList<MostPopularDataDetailModel> movies, Context context) {
        this.mMovies = movies;
