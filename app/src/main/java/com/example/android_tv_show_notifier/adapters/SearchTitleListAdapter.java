...
public class SearchTitleListAdapter extends RecyclerView.Adapter<SearchTitleListAdapter.MovieViewHolder> {

    private ArrayList<SearchResultsModel> mMovies = new ArrayList<SearchResultsModel>();
    private Context mContext;

    public SearchTitleListAdapter(ArrayList<SearchResultsModel> movies, Context context) {
        this.mMovies = movies;
    ...
    public void onBindViewHolder(MovieViewHolder viewHolder, final int position) {
        ...
        viewHolder.getReleaseYearTextView().setText(this.mMovies.get(position).getDescription());
